...
class CategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($request->hasFile('photo'))
        {
            ...
            $filename       =   'cat_'.uniqid() . '_' . str_replace(' ', '', $image->getClientOriginalName());
            $image->storeAs('public/photos/category/', $filename);
            $fullUrl        = url(env('APP_URL').'/storage/app/public/photos/category/'.$filename);
            $data['photo']  = $fullUrl;
