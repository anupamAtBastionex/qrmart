...
{
    protected $fillable=['user_id','order_number', 'product_name', 'product_id', 'sub_total','quantity','delivery_charge','status','total_amount','first_name','last_name','country','post_code','address1','address2','phone','email','payment_method','payment_status','shipping_id','coupon','size','color'];
    protected $appends = ['user_id','order_number', 'product_name', 'product_id', 'sub_total','quantity','delivery_charge','status','total_amount','first_name','last_name','country','post_code','address1','address2','phone','email','payment_method','payment_status','shipping_id','coupon', 'size', 'color'];
