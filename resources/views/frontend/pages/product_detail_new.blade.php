...
@endsection
@section('title','QR MART || PRODUCT DETAIL')
                                    ...
                                    <div class="flexslider-thumbnails">
                                        <ul class="slides">
                                            ...
                                            @php $fullUrl = url(env('APP_URL').'/storage/app/public/photos/'.$product_detail->id.'/'.$data->image) @endphp
                                                <li data-thumb="{{ $fullUrl }}" rel="adjustX:10, adjustY:">
                            ...
                            <div class="col-lg-6 col-12">
                                <div class="product-des">
                                    ...
                                    <div class="short">
                                        ...
                                        @endphp
                                        <p class="price"><span class="discount">{{number_format($after_discount,2)}} AED</span><s>{{number_format($product_detail->price,2)}} AED</s> </p>
                                    ...
                                    <div class="product-buy">
                                        <form action="{{route('cart.order_new')}}" method="POST">
                                            @csrf
                                                ...
                                                <div class="col-lg-12 col-md-12 col-12">
                                                    ...
                                                    <div class="input-group input-group-sm">
                                                        <div class="input-group-prepend prefix-code">
                                                            <img src="https://reliancezone.ae/uploads/lib/AE.png" width="20">
                                                            <span class="input-group-text" id="inputGroup-sizing-sm">+971 </span>
                                                        </div>
                                                        <input type="text" name="phone" class="form-control" aria-label="Small" placeholder="Mobile" aria-describedby="inputGroup-sizing-sm" required="">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12 col-12">
                                                        <label>Address</label>
                                                        <textarea name="address1" placeholder="Delivery Address"></textarea>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12 col-12 cart">
                                                    <label>Emirates<span>*</span></label><br>
                                                    <?php //print_r(count(Helper::shipping())); ?>
                                                    @if(count(Helper::shipping())>0)
                                                        <select name="shipping" class="" required style="width: 100%">
                                                            <option value="">Select your address</option>
                                                            @foreach(Helper::shipping() as $shipping)
                                                                <option value="{{$shipping->id}}" class="shippingOption" data-price="{{$shipping->price}}">{{$shipping->type}}: {{$shipping->price}} AED</option>
                                                            @endforeach
                                                        </select>
                                                    @else
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 col-md-6 col-6 cart">
                                                    <label>Size<span>*</span></label><br>
                                                    @php
                                                        $sizes=explode(',',$product_detail->size);
                                                    @endphp
                                                    <select name="size" class="" required style="width: 100%">
                                                ...
                                                <div class="col-lg-6 col-md-6 col-6  cart">
                                                    ...
                                                    @endphp
                                                    <select name="color" class="" required style="width: 100%">
                                                    {{-- <select name="size" class="form-control "> --}}
                                            ...
                                            <div class="add-to-cart mt-4">
                                                ...
                                                <input name="country"  type="hidden" value="AE">
